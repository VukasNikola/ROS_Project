...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<GetObjectPose-request>)))
  ...
  "d6d4f3bebbf31073267f6fff2a596a9a")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'GetObjectPose-request)))
  "Returns md5sum for a message object of type 'GetObjectPose-request"
  "d6d4f3bebbf31073267f6fff2a596a9a")
...
(cl:defmethod obj_id-val ((m <GetObjectPose-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader assignment2_package-srv:obj_id-val is deprecated.  Use assignment2_package-srv:obj_id instead.")
  (obj_id m))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <GetObjectPose-response>) ostream)
  ...
  (cl:write-byte (cl:ldb (cl:byte 8 16) (cl:slot-value msg 'obj_id)) ostream)
  (cl:write-byte (cl:ldb (cl:byte 8 24) (cl:slot-value msg 'obj_id)) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <GetObjectPose-response>) istream)
  "Deserializes a message object of type '<GetObjectPose-response>"
    ...
    (cl:setf (cl:ldb (cl:byte 8 16) (cl:slot-value msg 'obj_id)) (cl:read-byte istream))
    (cl:setf (cl:ldb (cl:byte 8 24) (cl:slot-value msg 'obj_id)) (cl:read-byte istream))

...
class PlaceObjectResponse {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type PlaceObjectResponse
    let len;
  ...
  static datatype() {
    // Returns string type for a service object
    return 'assignment2_package/PlaceObjectResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new PlaceObjectResponse(null);

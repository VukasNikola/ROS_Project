...
// (in-package assignment2_package.msg)
...
class ObjectPoseArray {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    for (let i = 0; i < len; ++i) {
      data.objects[i] = ObjectPose.deserialize(buffer, bufferOffset)
    }
    return data;
  }
  ...
  static messageDefinition() {
    ...
    return `
    assignment2_package/ObjectPose[] objects
    ================================================================================
  ...
  static Resolve(msg) {
    ...
    if (msg.objects !== undefined) {
      ...
      for (let i = 0; i < resolved.objects.length; ++i) {
        resolved.objects[i] = ObjectPose.Resolve(msg.objects[i]);
      }
    }
    else {
      resolved.objects = []

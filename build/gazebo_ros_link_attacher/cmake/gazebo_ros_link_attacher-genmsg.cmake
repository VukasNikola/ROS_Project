...
get_filename_component(_filename "/home/nikolavukas/project/src/gazebo_ros_link_attacher/srv/Attach.srv" NAME_WE)
add_custom_target(_gazebo_ros_link_attacher_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "gazebo_ros_link_attacher" "/home/nikolavukas/project/src/gazebo_ros_link_attacher/srv/Attach.srv" ""
)
...
_generate_srv_cpp(gazebo_ros_link_attacher
  "/home/nikolavukas/project/src/gazebo_ros_link_attacher/srv/Attach.srv"
  "${MSG_I_FLAGS}"
  ""
